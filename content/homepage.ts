...
export const homepage = {
  metadata: {
    title:
      "Натяжные потолки: теневые и парящие — цена за 2 минуты | ПОТОЛКОВО",
    description:
    ...
    /**
     * N-062 (F-30): отдельный кадр 1200×630 под соцсети. Раньше в og уходил
     * hero1.jpeg — 752 КБ и пропорции 3:2, которые соцсети обрезают по центру.
     * Собирается `scripts/build-og-image.mjs`.
     */
    ogImageSrc: "/optimized/og-cover-1200x630.webp",
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: "index, follow",
  },
  ...
  header: {
    ...
    // T-040: primary хедера ведёт в калькулятор, замер остаётся телефоном рядом.
    primaryCtaLabel: "Рассчитать за 2 минуты",
  ...
  hero: {
    mode: "static",
    // T-040: тексты раздела 6.2 ТЗ. Один primary CTA, один подзаголовок.
    h1: "Теневые и парящие потолки под ключ — делаю сам, смета фиксируется до монтажа",
    subtitle:
      "От 1 000 ₽/м² · ориентир за 2 минуты в калькуляторе · 5.0 на Avito",
    primaryCtaLabel: "Рассчитать за 2 минуты",
    secondaryCtaLabel: "Записаться на замер",
    /** Строка фактов под CTA. `{reviews}` подставляется из профиля Avito. */
    factsTemplate: "5.0 на Avito · {reviews} отзывов · договор и гарантия 2 года",
    portraitAssetKey: "vladimir-portrait",
    portraitCaption: "Владимир. 1 объект = 1 мастер, без бригад-подрядчиков",
  ...
  proof: {
    ...
    items: [
      ...
      },
      {
        ...
        budgetNote: "Цена включает потолок, карнизную нишу, трековый комплект и скидку −25% на свет с потолком.",
        ctaLabel: "Хочу похожее решение",
        actionTargetId: "action",
        actionPreset: {
          ceilingType: "floating",
  ...
  trust: {
    ...
    sectionIntro:
      "Без обезличенной компании и менеджеров между нами. От замера до монтажа объект веду сам и заранее проговариваю все решения.",
    ...
    founder: {
      ...
      bioLines: [
        ...
        "Согласовываю решения заранее и фиксирую смету до старта работ.",
      ],
    ...
    bullets: [
      ...
      },
      {
        ...
        description:
          "Фиксирую объем, материалы и стоимость заранее, без скрытых доплат после начала монтажа.",
      },
      {
        title: "Понятные сроки",
        description:
          "Согласовываю удобную дату монтажа и соблюдаем договоренности по времени.",
      },
      {
  ...
  promise: {
    ...
    sectionIntro:
      "Без сложной бюрократии: быстро выходим на замер, согласовываю решение, фиксирую смету и делаю монтаж в согласованный день.",

    guarantees: [
      {
        label: "Договор и гарантия",
        detail: "Фиксирую стоимость и сроки до начала работ.",
      },
      {
      ...
      },
      {
        ...
        detail: "Согласовываю решения заранее, чтобы всё выглядело чисто.",
      },
    ],

    includedLine:
      "После замера фиксирую решение и смету. По желанию — подберу освещение и крепления под ваш проект.",

    closingNote:
      "Обычно монтаж занимает 1 день для стандартных объектов. По сложным проектам срок согласую заранее.",
    ...
    processSteps: [
      ...
      },
      {
        ...
        description:
          "Снимаю размеры, смотрю геометрию, примыкания, крепления и свет.",
      },
      {
        stepLabel: "Шаг 3",
      ...
      },
      {
        ...
        description:
          "Делаю монтаж аккуратно и в срок. Принимаете готовый результат.",
      },
    ],
