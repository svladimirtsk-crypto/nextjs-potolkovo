export const homepage = {
  ...
  hero: {
    ...
    subtitle:
      "Теневой профиль, парящие потолки, световые линии, трековое освещение и скрытые карнизы. Работаю лично, делаю точный замер и фиксирую смету до начала монтажа.",
    primaryCtaLabel: "Записаться на замер",
    trustChips: [
      { label: "Личный монтаж" },
    ...
    servicesInlineLabel:
      "Теневой профиль · Парящие потолки · Световые линии · Треки · Скрытые карнизы",
    secondaryMicrocopy:
      "Бесплатный замер и понятный ориентир по стоимости уже на первом разговоре.",
  ...
  proof: {
    ...
    sectionIntro:
      "Показываю объекты, которые уже сделаны: с типом решения, масштабом и ориентиром по бюджету.",
