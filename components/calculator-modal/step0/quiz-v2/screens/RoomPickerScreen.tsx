...
export function RoomPickerScreen({ rooms, mode, onAdd, onSelect, onBack }:{
  ...
  return (
    <section className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm">
      ...
      {rooms.length>0 && (
        <div className="mt-4">
          <p className="text-xs uppercase tracking-wider text-slate-400 mb-2">Помещения в расчёте</p>
      ...
      <div className="mt-4">
        <p className="text-xs uppercase tracking-wider text-slate-400 mb-2">Добавить помещение</p>
        <div className="flex flex-wrap gap-2">
          {ROOM_TYPES.map(t=>(
