    ...
    <div aria-hidden={!isOpen} className={`fixed inset-0 z-[120] ${modalActive ? "pointer-events-auto" : "pointer-events-none"}`}>
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <div ref={contentRef} className="flex-1 overflow-y-auto px-5 py-5 max-lg:pb-52 max-sm:px-4 max-sm:py-4">
            <div
              key="step0"
          ...
          {/* Footer */}
          <div
            className="shrink-0 border-t border-slate-200 bg-white px-5 py-4 max-lg:fixed max-lg:inset-x-0 max-lg:bottom-0 max-lg:z-[145] max-lg:px-4 max-lg:py-3 max-lg:shadow-[0_-8px_24px_rgba(15,23,42,0.10)]"
