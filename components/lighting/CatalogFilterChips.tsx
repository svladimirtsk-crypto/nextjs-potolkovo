 ...
 *
 * Живёт в `components/lighting/`, а не в папке страницы: ту же ленту рисует
 * каталог внутри модалки. Пока компонент лежал в `app/uslugi/.../_components`,
 * мастер держал собственную копию разметки — четыре инлайн-блока, которые
 * успели разойтись с оригиналом по отступам и поведению поиска.
 *
