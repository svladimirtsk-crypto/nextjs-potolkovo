...
export function PriceCalculatorClient() {
  const [area, setArea] = useState(calculator.areaDefault);
  ...
  return (
    <div className="grid gap-8 rounded-[2rem] border border-slate-200 bg-white p-6 sm:p-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10 lg:p-10">
      <div>
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between gap-4">
            <label htmlFor="area" className="text-sm font-semibold text-slate-950">
              Площадь помещения
            </label>
        ...
        <div className="mt-8 space-y-2 rounded-2xl bg-slate-50 p-4">
          ...
          <div className="border-t border-slate-200 pt-3 text-sm font-semibold text-slate-950">
            <div className="flex items-center justify-between gap-4">
      ...
      <div className="rounded-[1.75rem] bg-slate-950 p-6 text-white sm:p-8">
        ...
        <div className="mt-8 space-y-3 text-sm leading-6 text-white/72">
          <p>{homepage.price.includedLine}</p>
          <p>{homepage.price.fixedPriceNote}</p>
        </div>

        <div className="mt-8">
          <Button href="#action" variant="secondary" className="w-full justify-center">
