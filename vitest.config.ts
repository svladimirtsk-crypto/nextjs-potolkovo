...
const DB_TESTS = [
  ...
  // PT-020: интеграция доставки — те же таблицы (`leads`, `lead_deliveries`,
  // `delivery_alerts`), та же полная очистка в `beforeEach`.
  "tests/lead-delivery-integration-db.test.ts",
