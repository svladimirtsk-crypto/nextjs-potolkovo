...
export default function Home() {
  ...
  const advantages = [
    { num: "15+", label: "лет опыта", sub: "с 2010 года", icon: "📅", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80" },
    { num: "∞", label: "сложность", sub: "любые проекты", icon: "🔧", image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=600&q=80" },
    { num: "1", label: "мастер", sub: "я лично", icon: "👤", image: "https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=600&q=80" },
    { num: "0", label: "посредников", sub: "прямая работа", icon: "🤝", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80" },
  ];

  const services = [
    { image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&q=80", emoji: "⬛", title: "Теневой профиль", desc: "Потолок без плинтуса. Чёткий теневой зазор 8 мм. Выглядит дорого, потому что это дорого сделать правильно." },
    { image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=80", emoji: "💡", title: "Парящие потолки", desc: "LED-подсветка по периметру. Потолок визуально отрывается от стен. Работает и как основной свет." },
    { image: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&q=80", emoji: "📐", title: "Световые линии", desc: "Встроенные в полотно линейные светильники. Любая геометрия. Замена люстрам и точечникам." },
    { image: "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=400&q=80", emoji: "🔦", title: "Трековое освещение", desc: "Встраиваемые треки в натяжной потолок. Направленный свет. Полный расчёт освещённости." },
    { image: "https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=400&q=80", emoji: "🪟", title: "Скрытые карнизы", desc: "Ниша под шторы прямо в потолке. Карниз не виден. Шторы будто растут из потолка." },
    { image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=400&q=80", emoji: "🏗️", title: "Индивидуальные проекты", desc: "Купола, многоуровневые конструкции, нестандартные формы. Если можно натянуть — сделаю." },
    { image: "https://images.unsplash.com/photo-1524484485831-a92ffc0de03f?w=400&q=80", emoji: "🛒", title: "Продажа трекового освещения", desc: "Подберу и продам трековые системы под ваш проект. Магнитные треки, споты, линейные светильники." },
    { image: "https://images.unsplash.com/photo-1600210491369-e753d80a41f3?w=400&q=80", emoji: "🏠", title: "Простые потолки для квартиры", desc: "Классический белый матовый или сатиновый потолок. Быстро, ровно, недорого. Идеально для ремонта квартир." },
    { image: "https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=400&q=80", emoji: "📊", title: "Многоуровневые потолки", desc: "Два и более уровней. Комбинация материалов, встроенная подсветка, зонирование пространства светом и формой." },
  ];

  const projects = [
    { title: "Купол с подсветкой", desc: "Индивидуальный проект: объёмный купол из натяжного полотна с интегрированной RGB-подсветкой. Полностью кастомная конструкция.", tags: ["Индивидуальный проект", "RGB", "Сложная геометрия"], images: [
      "https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&q=80",
      "https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=800&q=80",
      "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80",
    ]},
    { title: "Теневой профиль + трек", desc: "Квартира 120 м². Теневое примыкание по периметру, трековое освещение, чистые линии без плинтусов.", tags: ["Теневой профиль", "Трековый свет", "Минимализм"], images: [
      "https://images.unsplash.com/photo-1600607687644-c7171b42498f?w=800&q=80",
      "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800&q=80",
      "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=800&q=80",
    ]},
    { title: "Парящий потолок", desc: "Парящая конструкция с LED-лентой по контуру. Эффект «отрыва» потолка от стен. Гостиная + коридор.", tags: ["Парящий", "LED", "Световой контур"], images: [
      "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&q=80",
      "https://images.unsplash.com/photo-1600573472591-ee6b68d14c68?w=800&q=80",
      "https://images.unsplash.com/photo-1616137466211-f736a1eb238a?w=800&q=80",
    ]},
    { title: "Световые линии", desc: "Офисное пространство. Геометричные световые линии вместо стандартных светильников. Расчёт освещённости по нормам.", tags: ["Световые линии", "Офис", "Расчёт света"], images: [
      "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80",
      "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800&q=80",
      "https://images.unsplash.com/photo-1604328698692-f76ea9498e76?w=800&q=80",
    ]},
    { title: "Скрытый карниз", desc: "Ниша под карниз в натяжном потолке. Шторы «из потолка» — чистый вид, никаких накладок.", tags: ["Скрытый карниз", "Ниша", "Чистый вид"], images: [
      "https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=800&q=80",
      "https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?w=800&q=80",
      "https://images.unsplash.com/photo-1600210491892-03d54c0aaf87?w=800&q=80",
    ]},
    { title: "Матовые потолки", desc: "Классика, которая не устаревает. Ровная матовая поверхность без бликов. Идеально для жилых комнат и спален.", tags: ["Матовый", "Классика", "Квартира"], images: [
      "https://images.unsplash.com/photo-1600210491369-e753d80a41f3?w=800&q=80",
      "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=800&q=80",
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80",
    ]},
    { title: "Контурная подсветка", desc: "Светодиодная лента по контуру потолка за полупрозрачной вставкой. Мягкое свечение, уютная атмосфера, управление с пульта.", tags: ["Контурная подсветка", "LED", "Атмосфера"], images: [
      "https://images.unsplash.com/photo-1600573472591-ee6b68d14c68?w=800&q=80",
      "https://images.unsplash.com/photo-1631679706909-1844bbd07221?w=800&q=80",
      "https://images.unsplash.com/photo-1616137466211-f736a1eb238a?w=800&q=80",
    ]},
  ...
  const processSteps = [
    { step: "01", title: "Заявка", desc: "Вы пишете или звоните. Обсуждаем задачу, бюджет, сроки. Без навязывания.", icon: "📱", image: "https://images.unsplash.com/photo-1423666639041-f56000c27a9a?w=400&q=80" },
    { step: "02", title: "Замер", desc: "Приезжаю, замеряю, считаю. Точная смета на месте. Без «потом уточним».", icon: "📏", image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=400&q=80" },
    { step: "03", title: "Монтаж", desc: "Монтирую в оговорённый день. Чисто, аккуратно, по технологии. Обычно 1 день.", icon: "⚙️", image: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&q=80" },
    { step: "04", title: "Готово", desc: "Принимаете работу. Всё чисто. Даю гарантию. Работа говорит за себя.", icon: "✅", image: "https://images.unsplash.com/photo-1600210491369-e753d80a41f3?w=400&q=80" },
  ];
  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        }} onClick={()=>scrollTo("hero")}>ПОТОЛКОВО</div>
          ...
          <div className={`advantages-grid fade-up ${isVisible("advantages")?"visible":""}`} style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:0}}>
            {advantages.map((a,i)=>(
              <div key={i} className={`fade-up ${isVisible("advantages")?"visible":""} fade-up-d${i+1}`}
                style={{position:"relative",overflow:"hidden",minHeight:320,display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:32,
                  borderRight:i<3?"1px solid rgba(255,255,255,0.08)":"none",transition:"all .3s",cursor:"default",
                }}
              ...
              >
                ...
                <div style={{position:"relative",zIndex:2,textAlign:"center"}}>
                  ...
                  <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:48,fontWeight:700,marginBottom:4}}>{a.num}</div>
          ...
          <div className="hero-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:80,alignItems:"start"}}>
            <div className={`fade-up ${isVisible("about")?"visible":""}`}>
              ...
              <div style={{width:"100%",aspectRatio:"3/2",marginBottom:32,position:"relative",overflow:"hidden",border:"1px solid #e8e8e8"}}>
                <Image src="https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=800&q=80" alt="Владимир — мастер по натяжным потолкам" fill sizes="(max-width:768px) 100vw, 50vw" style={{objectFit:"cover"}}/>
      ...
      <section style={{padding:"80px clamp(24px,5vw,80px)",position:"relative",overflow:"hidden",minHeight:400,display:"flex",alignItems:"center",justifyContent:"center"}}>
        <Image src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=1400&q=80" alt="Интерьер с натяжным потолком" fill sizes="100vw" style={{objectFit:"cover"}}/>
          ...
          <div className="contact-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:80,marginTop:64}}>
            ...
            <div className={`fade-up fade-up-d3 ${isVisible("contact")?"visible":""}`} style={{display:"flex",flexDirection:"column",gap:28}}>
              {[
                ...
                {label:"Telegram",value:"Написать в Telegram",icon:"✈️",href:"https://t.me/potolkovo"},
                {label:"Email",value:"potolkovo@mail.ru",icon:"📧",href:"mailto:potolkovo@mail.ru"},
      ...
      <footer style={{padding:"60px clamp(24px,5vw,80px)",background:"#1a1a1a",color:"#fff",borderTop:"1px solid #333"}}>
        <div style={{maxWidth:1400,margin:"0 auto"}}>
          <div className="footer-grid" style={{display:"grid",gridTemplateColumns:"1.2fr 1fr 1fr",gap:80,alignItems:"start"}}>
            <div>
              <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:18,fontWeight:700,letterSpacing:3,marginBottom:16}}>ПОТОЛКОВО</div>
            ...
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                {["Теневой профиль","Парящие потолки","Световые линии","Трековое освещение","Скрытые карнизы","Простые потолки","Многоуровневые","Продажа трек-света"].map(s=>(
