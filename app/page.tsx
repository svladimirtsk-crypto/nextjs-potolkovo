    ...
    >
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .service-card::before{content:'';position:absolute;top:0;left:0;width:100%;height:3px;background:#1a1a1a;transform:scaleX(0);transform-origin:left;transition:transform .4s cubic-bezier(.16,1,.3,1)}
        ...
        <div className="desktop-nav" style={{display:"flex",gap:32,alignItems:"center"}}>
          {[["Услуги","services"],["Проекты","projects"],["О нас","about"],["Контакт","contact"]].map(([label,id])=>(
            <button key={id} className="nav-link" onClick={()=>scrollTo(id)}
              style={{color:scrollY>50?"#666":"rgba(255,255,255,0.8)"}}>{label}</button>
          ))}
      ...
      <section id="hero" style={{
        ...
        {/* Background slides via next/image */}
        ...
        <div style={{
          maxWidth:1400,width:"100%",margin:"0 auto",position:"relative",zIndex:2,
          ...
          <div style={{display:"flex",gap:16,flexWrap:"wrap",marginBottom:48}}>
            ...
            <button className="cta-btn" style={{background:"transparent",border:"2px solid rgba(255,255,255,0.5)"}}
        ...
        <div style={{position:"absolute",bottom:40,right:"clamp(24px,5vw,80px)",display:"flex",gap:8,zIndex:3}}>
          <button className="slide-arrow"
            onClick={()=>setHeroSlide((heroSlide-1+heroImages.length)%heroImages.length)}>←</button>
          <button className="slide-arrow"
            onClick={()=>setHeroSlide((heroSlide+1)%heroImages.length)}>→</button>
        </div>
      </section>
      ...
      <section id="advantages" style={{
        ...
        <div style={{maxWidth:1400,margin:"0 auto"}}>
          <div className={`advantages-grid fade-up ${isVisible("advantages")?"visible":""}`}
            ...
            {advantages.map((a,i)=>(
              <div key={i}
                ...
                style={{
                  ...
                  border:"1px solid rgba(255,255,255,0.1)",transition:"border-color .3s",
                }}
      ...
      <section id="projects" style={{
        ...
        <div style={{maxWidth:1400,margin:"0 auto",position:"relative",zIndex:1}}>
          ...
          <div className="project-tabs" style={{
            ...
            {projects.map((p,i)=>(
              <button key={i} className={`project-tab ${activeProject===i?"active":""}`}
                onClick={()=>setActiveProject(i)}>{p.title}</button>
            ))}
          </div>
          <div className="hero-grid" style={{
            ...
            <div style={{position:"relative",overflow:"hidden"}}>
              <div style={{
                ...
                {projects[activeProject].images.map((img,i)=>(
                  <div key={`${activeProject}-${i}`} style={{
                    position:"absolute",inset:0,
                    opacity:projectSlide===i?1:0,transition:"opacity .6s ease",
                  }}>
                    <Image
                      src={img}
                      alt={`${projects[activeProject].title} — фото ${i+1}`}
                      fill
                ...
                <div style={{
                  position:"absolute",bottom:16,right:16,display:"flex",gap:8,zIndex:2,
                }}>
              ...
              <div style={{display:"flex",gap:6,marginTop:12,justifyContent:"center"}}>
                {projects[activeProject].images.map((_,i)=>(
                  <button key={i} className={`slide-dot ${projectSlide===i?"active":""}`}
            ...
            <div>
              ...
              <button className="cta-btn" style={{fontSize:13,padding:"14px 28px"}}
                onClick={()=>scrollTo("contact")}>Хочу такой же →</button>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="hero-grid" style={{
            ...
            <div className={`fade-up ${isVisible("about")?"visible":""}`}>
              ...
              <div style={{
                ...
                position:"relative",overflow:"hidden",border:"1px solid #e8e8e8",
              }}>
                <Image
                  src="https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=800&q=80"
                ...
                <div style={{
                  ...
                  letterSpacing:1,textTransform:"uppercase",zIndex:2,
                }}>
                  Владимир / Основатель
                </div>
              </div>
            ...
            <div className={`fade-up fade-up-d2 ${isVisible("about")?"visible":""}`}
              ...
              {[
                ...
                <div key={i} style={{
                  padding:28,background:"#fff",border:"1px solid #e8e8e8",transition:"border-color .3s",
                }}
      ...
      <section style={{
        ...
        <Image
          ...
          alt="Интерьер с натяжным потолком"
          fill
          sizes="100vw"
          style={{objectFit:"cover"}}
        />
        ...
        <div style={{
          ...
          <div style={{display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap"}}>
            <a href="tel:+79055219909" className="cta-btn cta-btn-white" style={{textDecoration:"none"}}>
              📞 +7 905 521 99 09
            </a>
      ...
      <section id="contact" style={{
        ...
        <div style={{maxWidth:1400,margin:"0 auto",position:"relative",zIndex:1}}>
          ...
          <div className="contact-grid" style={{
            ...
            <div className={`fade-up fade-up-d3 ${isVisible("contact")?"visible":""}`}
