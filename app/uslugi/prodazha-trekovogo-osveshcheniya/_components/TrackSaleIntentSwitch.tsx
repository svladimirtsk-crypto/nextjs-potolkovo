...
> = {
  install: {
    hint:
      "Замер, подбор трекового освещения и монтаж натяжного потолка. Скидка −25% на всё освещение.",
    ctaLabel: "На бесплатный замер",
    ctaSubtext: "и скидка −25% на свет",
  },
  buy: {
    hint:
      "Подберём комплект трекового освещения под ваш проект. Только свет — со скидкой −10%.",
